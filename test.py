    ...
    for file in categories[category]:
        with open(file, encoding='utf-8') as f:
            ...
            for line in csv.reader(f, delimiter=";"):
                ...
                assert is_proper_coordinate(line[2]), "Line {} latitude should be a proper coordinate".format(i, file)
                assert is_proper_coordinate(line[3]), "Line {} longitude should be a proper coordinate".format(i, file)
